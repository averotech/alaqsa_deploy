                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        child:Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            CustomSectionComponent.StartingEndingPoint(context: context,margin: EdgeInsets.only(top: 16),title: 'مكانك الحالي',location: '${myAddress != "" ? myAddress:"غير معروف"}}',clockIcon: 'assets/icons/clock.svg',time: trip.startTime.toString(),distanceIcon: 'assets/icons/distance.svg',km:'كم ' + (trip.fromDistance != null?trip.fromDistance.toString():"0.0"),globalColor: Color(0xffB7B7B7),iconColor:Color(0xffB7B7B7),titleColor: Theme.of(context).primaryColor),
                                            CustomSectionComponent.StartingEndingPoint(context: context,margin: EdgeInsets.only(top: 16),title: 'مكان الأنطلاق',location: trip.from.addressLocation != null ? trip.from.addressLocation.toString().length>30? trip.from.addressLocation.toString().substring(0,30):trip.from.addressLocation.toString():"غير معروف" ,clockIcon: 'assets/icons/clock.svg',time: trip.endTime,distanceIcon: 'assets/icons/distance.svg',km: 'كم ' +  (trip.fromDistance != null?trip.fromDistance.toString():"0.0"),globalColor: Color(0xff101426),iconColor:Theme.of(context).primaryColor,titleColor: Theme.of(context).primaryColor),
                                            CustomSectionComponent.StartingEndingPoint(context: context,margin: EdgeInsets.only(top: 16),title: 'مكان الوصول',location: trip.to.addressLocation  != null ? trip.to.addressLocation.toString().length>30? trip.to.addressLocation.toString().substring(0,30):trip.to.addressLocation.toString():'المسجد الأقصى',clockIcon: 'assets/icons/clock.svg',time: trip.endTime,distanceIcon: 'assets/icons/distance.svg',km: 'كم ' +  (trip.fromDistance != null?trip.toDistance.toString():"0.0"),globalColor: Color(0xff101426),iconColor:Theme.of(context).primaryColor,titleColor: Theme.of(context).primaryColor),
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              Container(
                                                                margin: EdgeInsets.only(right: 2),
                                                                child: Text("${trip.from.addressLocation != null ? trip.from.addressLocation.toString().length>30? trip.from.addressLocation.toString().substring(0,30):trip.from.addressLocation.toString():"غير معروف"}",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w600,fontFamily: 'SansArabicLight',color:Color(0xff101426)),),
                                                              ),
